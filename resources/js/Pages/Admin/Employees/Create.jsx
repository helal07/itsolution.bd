...
export default function Create({ availableRoles = [], availableDepartments = [] }) {
            ...
            <div className="max-w-6xl mx-auto space-y-6 pb-16">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        <div className="flex items-center gap-2 text-xs text-slate-500 font-medium mb-1">
                            ...
                            <span>/</span>
                            <span className="text-slate-900 font-bold">Add Team Member</span>
                        </div>
                        <h1 className="font-black text-2xl sm:text-3xl text-slate-900 tracking-tight flex items-center gap-2.5">
                            <span>Add New Team Member</span>
                        </h1>
                        <p className="text-xs text-slate-500 mt-0.5">
                            Fill in complete personal, credentials, operational, and bank details
                        </p>
                    </div>
                    ...
                    <div className="flex items-center gap-2.5 self-start sm:self-auto">
                        ...
                        >
                            ...
                            <span>{processing ? 'Saving...' : 'Save Member'}</span>
                        </button>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="p-6 rounded-2xl bg-white border border-slate-200/80 shadow-xs space-y-5">
                        ...
                        {data.allow_login ? (
                            ...
                            <p className="text-xs text-slate-500 italic bg-slate-50 p-3 rounded-xl border border-slate-100">
                                Check <strong>Allow Login</strong> above to create login credentials and assign a system role.
                            </p>
                        )}
                    </div>
                    ...
                    <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-200">
                        ...
                        >
                            <Save className="w-4 h-4" />
                            <span>{processing ? 'Saving Team Member...' : 'Save Member'}</span>
                        </button>
                    </div>
                </form>
            </div>
