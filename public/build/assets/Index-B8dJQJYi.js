...
Thank you for choosing IT SOLUTIONS!`);window.open(`https://wa.me/${a}?text=${l}`,"_blank")},className:"inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-emerald-50 text-emerald-700 border border-emerald-200 font-bold hover:bg-emerald-100 text-xs transition-colors shadow-2xs cursor-pointer",children:[e.jsx(we,{className:"w-4 h-4 text-emerald-600"}),e.jsx("span",{children:"Send WhatsApp"})]})]}),e.jsx("button",{type:"button",onClick:()=>S(null),className:"px-5 py-2 rounded-xl bg-slate-100 text-slate-700 font-bold hover:bg-slate-200 text-xs transition-colors cursor-pointer",children:"Close"})]})]})})]})}export{nt as default};
